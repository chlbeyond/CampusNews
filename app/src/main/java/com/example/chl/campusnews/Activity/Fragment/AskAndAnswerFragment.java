...
import com.example.chl.campusnews.Activity.AskActivity;
...
public class AskAndAnswerFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ask_and_answer, container, false);
        initHead();
        initRecyclerView();
        initData();
        return view;
    ...
    private void initRecyclerView() {
        ...
        adapter = new MyRecyclerViewAdapter(getActivity(), newsRecyclerItemInfos, MyRecyclerViewAdapter.ASKFRAGMENT);
