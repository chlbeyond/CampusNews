...
public class MeAnswerFragment extends Fragment {
    ...
    public MeAnswerFragment() {
        // Required empty public constructor
    }

    public static MeAnswerFragment newInstance() {
        return new MeAnswerFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_me_answer, container, false);
        initRecyclerView();
        initData();
        return view;
    }
    ...
    private void initRecyclerView() {
        ...
        adapter = new MyRecyclerViewAdapter(getActivity(), newsRecyclerItemInfos, MyRecyclerViewAdapter.MENANSWERFRAGMENT);
