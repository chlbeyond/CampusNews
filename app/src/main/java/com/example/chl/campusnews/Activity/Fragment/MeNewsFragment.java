...
public class MeNewsFragment extends Fragment {
    ...
    public MeNewsFragment() {
        // Required empty public constructor
    }

    public static MeNewsFragment newInstance() {
        return new MeNewsFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_me_news, container, false);
        initRecyclerView();
        initData();
        return view;
    }
    ...
    private void initRecyclerView() {
        ...
        adapter = new MyRecyclerViewAdapter(getActivity(), newsRecyclerItemInfos, MyRecyclerViewAdapter.MENEWSFRAGMENT);
