...
import com.example.chl.campusnews.Activity.ReleaseActivity;
...
public class NewsFragment extends Fragment implements View.OnClickListener{
    ...
    private void initRecyclerView() {
        ...
        adapter = new MyRecyclerViewAdapter(getActivity(), newsRecyclerItemInfos, MyRecyclerViewAdapter.NEWSFRAGMENT);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.release:
                ...
                intent.putExtra(ReleaseActivity.FROM, ReleaseActivity.NEWSFRAGMENT);
